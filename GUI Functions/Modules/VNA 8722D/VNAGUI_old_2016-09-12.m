...
VNA.UI_add_setting('edit','freq_center1',3,2);
VNA.get_setting('freq_center1').UI_add_update();
...
VNA.UI_add_setting('edit','freq_center2',3,2);
VNA.get_setting('freq_center2').UI_add_update();
VNA.get_setting('freq_center2').set_state_and_UIvisibility(0);
